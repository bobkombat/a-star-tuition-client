...
export default function MainHeader() {
  ...
  return (
    <div className="h-full flex justify-end items-center mx-auto flex-wrap-reverse w-10/12 sm:my-0 md:my-20 lg:my-28 my-32">
      <div className="z-20 relative flex flex-col sm:justify-center pt-10 pb-2 sm:text-center text-left font-bold w-7/12 sm:w-screen text-8xl xl:text-7xl lg:text-5xl md:text-5xl sm:text-4xl max-w-full">
        <div
